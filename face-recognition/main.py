...
for _ in range(2):
    try:
        # This Module is published on Pypi which is specially made by Mahin Bin
        # Hasan for this AI project
...
# Label 8 -----------------------------------> Video Display NDITC logo
    ...
    def oc(self):
        ...
        while sts:
            ...
            for face_encoding in face_encodings:
                ...
                # Face Distance part control
                fd = face_distances[best_match_index]
                fd = float(fd)
                fd = 1 - fd
                fd = round(fd, 2)
                fd = fd * 100
            ...
            convert_to_Qt_format = QtGui.QImage(
                opencv_image.data, w, h, bytes_per_line, QtGui.QImage.Format_RGB888)
    ...
    def newwin(self):
        ...
        Lab = Label(
            win,
            text='AI based Face Recognition NDITC',
            font=(
                '',
                '12'))
        Lab.pack()
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.label_6.setText(
            _translate(
                "MainWindow",
                "EVYA.AI is Notre Dame Information Technology Club\'s Official Artificial Intelligence\n"
