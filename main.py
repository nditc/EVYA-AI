...
"}")
        ...
        self.lineEdit_4.setGeometry(QtCore.QRect(490, 260, 301, 31))
...
"}")
        self.label_7.setText("Video Display")
...
"}")
    ...
    def retranslateUi(self, MainWindow):
        _translate = QtCore.QCoreApplication.translate
        MainWindow.setWindowTitle(_translate("MainWindow", "EVYA.AI"))
        self.pushButton.setText(_translate("MainWindow", "RUN AI"))
        self.pushButton.clicked.connect(self.wth)
        self.label.setText(_translate("MainWindow", "EVYA.AI"))
